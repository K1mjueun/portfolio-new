...
const bubblePCbackBtn = document.querySelector("#bubbleroom-pc-page > #note-board >.pc-arrow-sticker");
// const bubblePCTopBtn = document.querySelector("#bubbleroom-pc-page > #note-board >.pc-top-sticker");
